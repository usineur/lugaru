/*
    ...
    OpenGL loader generated by glad 0.1.27 on Sun Sep 23 01:40:43 2018.
    ...
    Commandline:
        --profile="compatibility" --api="gl=3.2" --generator="c" --spec="gl" --local-files --omit-khrplatform --extensions="GL_ARB_debug_output,GL_EXT_texture_lod_bias"
    Online:
        http://glad.dav1d.de/#profile=compatibility&language=c&specification=gl&loader=on&api=gl%3D3.2&extensions=GL_ARB_debug_output&extensions=GL_EXT_texture_lod_bias
*/
